...
from run_chatpdf import load_model
from langchain.vectorstores import Chroma
from support.constants import CHROMA_SETTINGS, EMBEDDING_MODEL_NAME, PERSIST_DIRECTORY, MODEL_ID, MODEL_BASENAME
...
with st.sidebar:
    ...
    - [chatpdf](https://github.com/PromtEngineer/chatpdf) 
